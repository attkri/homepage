...
service:
  ...
  services:
    - title: "PowerShell-Automatisierung"
      image: "service-1"
      content: "Automatisierung, Skriptqualität, Hardening und Wissenstransfer für Teams, die PowerShell produktiv einsetzen müssen."
      button:
        enable: true
        label: "Zur Leistung"
...
feature:
  ...
  content: "Das Ziel ist nicht nur ein gelöstes Problem, sondern eine Lösung, die im Betrieb funktioniert und im Team bleibt."
  features:
    - title: "Befähigung statt Abhängigkeit"
      description: "Attila Krick löst Engpässe nicht nur technisch, sondern so, dass Teams anschließend sicherer weiterarbeiten können."
      card_content: "Lösungen sollen tragfähig bleiben - auch ohne dauerhafte Fremdsteuerung."
      icon: "FaAsterisk"
    ...
    - title: "KI mit Leitplanken"
      description: "Agenten sollen reale Arbeit unterstützen - mit klaren Rollen, Freigaben und sauberer technischer Anbindung."
      card_content: "Nicht jeder KI-Trend gehört in den Betrieb. Die Auswahl bleibt bewusst kontrolliert."
      icon: "FaExpand"
      image: "/images/leistung/ki-hub.webp"

about:
  title: "Attila Krick bringt **Technik, Betrieb und Wissenstransfer** zusammen"
  content: "Seit über 30 Jahren begleitet Attila Krick Unternehmen, Mittelstand und Behörden bei PowerShell, SQL Server, .NET und heute zunehmend auch bei KI-Agenten."
  content_2: "Der Fokus bleibt ruhig und praxisnah: klare Entscheidungen, belastbare Umsetzung und Trainings, die Teams wirklich weiterbringen."
