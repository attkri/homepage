...
Website wird von KI-Systemen (ChatGPT, Perplexity, Gemini, Copilot) als Quelle erkannt, zitiert und empfohlen.

## Umgesetzte Maßnahmen

- `static/llms.txt` – Kompakte Zusammenfassung für KI-Modelle (freigegeben 2026-02-09)
- `static/llms-full.txt` – Detaillierte Version mit Zitations-Hinweisen (freigegeben 2026-02-09)
- `static/robots.txt` – Sitemap-URL korrigiert (freigegeben 2026-02-09)
