    ...
    sitemap({
      filter: (page) => {
        const excludedPaths = new Set([
          "/about",
          "/contact",
          "/leistung/dotnet-beratung",
          "/leistung/dotnet-code-review",
          "/leistung/dotnet-seminar",
          "/leistung/ki-ausbau",
          "/leistung/ki-einfuehrung",
          "/leistung/ki-grundlagen",
          "/leistung/ki-kompass-seminar",
          "/leistung/ki-seminar",
          "/leistung/powershell-seminar",
          "/leistung/sql-performance-tuning",
          "/leistung/sql-server-beratung",
          "/leistung/tsql-sql-server-seminar",
          "/leistung/tsql-workshop",
          "/services",
          "/terms-of-service",
        ]);
